...
namespace Saber\Throwable\InvalidArgument {
	...
	final class ExceptionTest extends Core\TypeTest {
		...
		public function test_box(array $provided, array $expected) {
			$p0 = Throwable\InvalidArgument\Exception::make($provided);
		...
		public function testCompare(array $provided, array $expected) {
			$p0 = Throwable\InvalidArgument\Exception::make($provided[0])->compare(Throwable\InvalidArgument\Exception::make($provided[1]));
			$e0 = $expected[0];
