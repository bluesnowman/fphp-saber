...
namespace Saber\Data\Enum {
	...
	abstract class Type extends Data\Type {
		 ...
		 *
		 * @access protected
		 * @var String\Type                                         the name of the enumeration
		 */
		protected $name;
		 ...
		 *
		 * @access protected
		 * @var Int32\Type                                          the ordinal value assigned to the enumeration
		 */
		protected $ordinal;
		 ...
		 * @abstract
		 * @access protected
		 * @param String\Type $name                                 the name associated with the item
		 * @param Core\Type $item                                   the item to be stored
		 */
		protected abstract function __construct(String\Type $name, Core\Type $item);
		 ...
		 * @access public
		 * @final
		 * @return String\Type                                      the name assigned to the enumeration
		 */
		 ...
		 * @access public
		 * @final
		 * @return Int32\Type                                       the ordinal value assigned to the enumeration
		 */
