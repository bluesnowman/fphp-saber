...
namespace Saber\Throwable\UnexpectedValue {
	...
	class ExceptionTest extends Core\AnyTest {
		...
		public function testBox($provided, $expected) {
			$p0 = Throwable\UnexpectedValue\Exception::box($provided[0], $provided[1], $provided[2]);
		...
		public function testToString($provided, $expected) {
			$p0 = Throwable\UnexpectedValue\Exception::box($provided[0], $provided[1], $provided[2])->__toString();
			$e0 = $expected[0];
