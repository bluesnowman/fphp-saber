...
namespace Saber\Data\Double {
	...
	final class Type extends Data\Type implements Floating\Type, Real\Type {
		 ...
		 * @var string
		 */
		protected static $module = '\\Saber\\Data\\Double\\Module';
		 ...
		 * @access public
		 * @static
		 * @param Double\Type $x                                    the class to be evaluated
		 * @return Double\Type                                      the class
		 */
		public static function covariant(Double\Type $x) {
			return $x;
		}
