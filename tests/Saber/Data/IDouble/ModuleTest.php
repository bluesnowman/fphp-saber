...
namespace Saber\Data\IDouble {
	...
	final class ModuleTest extends Core\ModuleTest {
		...
		public function testAbs(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->abs();
			$e0 = $expected[0];
		...
		public function testAdd(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->add(IDouble\Type::make($provided[1]));
			$e0 = $expected[0];
		...
		public function testChoice() {
			...
			$x = IDouble\Type::make(3.0);

			$p0 = $x->choice();

			$this->assertInstanceOf('\\Saber\\Control\\Choice\\Type', $p0);

			$p1 = $x->choice()->when(IDouble\Type::make(3.0), function(IDouble\Type $x) {})->end()->unbox();

			$this->assertInternalType('boolean', $p1);
			$this->assertTrue($p1);

			$p2 = $x->choice()->when(IDouble\Type::make(-3.0), function(IDouble\Type $x) {})->end()->unbox();
		...
		public function testCompare(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->compare(IDouble\Type::make($provided[1]));
			$e0 = $expected[0];
		...
		public function testDecrement(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->decrement();
			$e0 = $expected[0];
		...
		public function testDivide(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->divide(IDouble\Type::make($provided[1]));
			$e0 = $expected[0];
		...
		public function testIncrement(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->increment();
			$e0 = $expected[0];
		...
		public function testModulo(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->modulo(IDouble\Type::make($provided[1]));
			$e0 = $expected[0];
		...
		public function testMultiply(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->multiply(IDouble\Type::make($provided[1]));
			$e0 = $expected[0];
		...
		public function testNegate(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->negate();
			$e0 = $expected[0];
		...
		public function testSubtract(array $provided, array $expected) {
			...
			$p0 = IDouble\Type::make($provided[0])->subtract(IDouble\Type::make($provided[1]));
			$e0 = $expected[0];
