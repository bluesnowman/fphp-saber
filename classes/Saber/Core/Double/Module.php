...
namespace Saber\Core\Double {
	...
	class Module {
		 ...
		 * @access public
		 * @static
		 * @param Core\Double $x                                    the operand
		 * @return Core\Double                                      the result
		 */
		public static function abs(Core\Double $x) {
			return Core\Double::create(abs($x->unbox()));
		}
		 ...
		 * @access public
		 * @static
		 * @param Core\Double $x                                    the left operand
		 * @param Core\Double $y                                    the right operand
		 * @return Core\Double                                      the result
		 */
		public static function add(Core\Double $x, Core\Double $y) {
			return Core\Double::create($x->unbox() + $y->unbox());
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function decrement(Core\Double $x) {
			return Core\Double\Module::subtract($x, Core\Double::one());
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function divide(Core\Double $x, Core\Double $y) {
			return Core\Double::create($x->unbox() / $y->unbox());
		}
		...
		protected function _gcd($x, $y) {
		    return ($y > 0.01) ? Core\Double\Module::_gcd($y, fmod($x, $y)) : $x;
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function increment(Core\Double $x) {
			return Core\Double\Module::add($x, Core\Double::one());
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function modulo(Core\Double $x, Core\Double $y) {
			return Core\Double::create(fmod($x->unbox(), $y->unbox()));
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function multiply(Core\Double $x, Core\Double $y) {
			return Core\Double::create($x->unbox() * $y->unbox());
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function negate(Core\Double $x) {
			return Core\Double::create($x->unbox() * -1.0);
		}
		 ...
		 * @return Core\Double                                      the result
		 */
		public static function subtract(Core\Double $x, Core\Double $y) {
			return Core\Double::create($x->unbox() - $y->unbox());
		}
		 ...
		 * @access public
		 * @static
		 * @param Core\Double $x                                    the object to be converted
		 * @return Core\Double                                      the value as a Double
		 */
		public static function toDouble(Core\Double $x) {
		 ...
		 */
		public static function toFloat(Core\Double $x) {
		 ...
		 */
		public static function toInt32(Core\Double $x) {
		 ...
		 */
		public static function toInteger(Core\Double $x) {
		 ...
		 */
		public static function toString(Core\Double $x) {
		 ...
		 */
		public static function compare(Core\Double $x, Core\Double $y) {
			$__x = $x->unbox();
			$__y = $y->unbox();
		 ...
		 */
		public static function ge(Core\Double $x, Core\Double $y) { // >=
			return (Core\Double\Module::compare($x, $y)->unbox() >= 0) ? Core\Bool::true() : Core\Bool::false();
		}
		 ...
		 */
		public static function gt(Core\Double $x, Core\Double $y) { // >
			return (Core\Double\Module::compare($x, $y)->unbox() > 0) ? Core\Bool::true() : Core\Bool::false();
		}
		 ...
		 */
		public static function le(Core\Double $x, Core\Double $y) { // <=
			return (Core\Double\Module::compare($x, $y)->unbox() <= 0) ? Core\Bool::true() : Core\Bool::false();
		}
		 ...
		 *                                                          the right operand
		 */
		public static function lt(Core\Double $x, Core\Double $y) { // <
			return (Core\Double\Module::compare($x, $y)->unbox() < 0) ? Core\Bool::true() : Core\Bool::false();
		}
		 ...
		 * @param Core\Double $x                                    the left operand
		 * @param Core\Double $y                                    the right operand
		 * @return Core\Double                                      the maximum value
		 */
		public static function max(Core\Double $x, Core\Double $y) {
			return (Core\Double\Module::compare($x, $y)->unbox() >= 0) ? $x : $y;
		}
		 ...
		 * @param Core\Double $x                                    the left operand
		 * @param Core\Double $y                                    the right operand
		 * @return Core\Double                                      the minimum value
		 */
		public static function min(Core\Double $x, Core\Double $y) {
			return (Core\Double\Module::compare($x, $y)->unbox() <= 0) ? $x : $y;
		}
		 ...
		 * @access public
		 * @static
		 * @param Core\Double $x                                    the object to be evaluated
		 * @return Core\String                                      the object's hash code
		 */
		public static function hashCode(Core\Double $x) {
			return Core\String::create($x->__toString());
		}
		 ...
		 *                                                          number
		 */
		public static function isNegative(Core\Double $x) {
