...
namespace Saber\Data {
	...
	class Int32Test extends Core\AnyTest {
		...
		public function testAbs($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->abs();
			$e0 = $expected[0];
		...
		public function testAdd($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->add(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testBox($provided, $expected) {
			$p0 = Int32\Module::box($provided[0]);
		...
		public function testChoice() {
			$x = Int32\Module::box(3);

			$p0 = $x->choice();

			$this->assertInstanceOf('\\Saber\\Control\\Monad\\Choice', $p0);

			$p1 = $x->choice()->when(Int32\Module::box(3), function(Int32\Type $x) {})->end()->unbox();

			$this->assertInternalType('boolean', $p1);
			$this->assertTrue($p1);

			$p2 = $x->choice()->when(Int32\Module::box(-3), function(Int32\Type $x) {})->end()->unbox();
		...
		public function testCompareTo($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->compareTo(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testDecrement($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->decrement();
			$e0 = $expected[0];
		...
		public function testDivide($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->divide(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testEven($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->even();
			$e0 = $expected[0];
		...
		public function testGCD($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->gcd(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testIncrement($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->increment();
			$e0 = $expected[0];
		...
		public function testModulo($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->modulo(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testMultiply($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->multiply(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testNegate($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->negate();
			$e0 = $expected[0];
		...
		public function testOdd($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->odd();
			$e0 = $expected[0];
		...
		public function testSubtract($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->subtract(Int32\Module::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testToString($provided, $expected) {
			$p0 = Int32\Module::box($provided[0])->__toString();
			$e0 = $expected[0];
