...
namespace Saber\Data {
	...
	class WrapperTest extends Core\AnyTest {
		...
		public function testChoice() {
			$x = Data\Object::box(null);

			$p0 = $x->choice();

			$this->assertInstanceOf('\\Saber\\Control\\Monad\\Choice', $p0);

			$p1 = $x->choice()->when(Data\Object::box(null), function(Data\Object $x) {})->end()->unbox();

			$this->assertInternalType('boolean', $p1);
			$this->assertTrue($p1);

			$p2 = $x->choice()->when(Data\Object::box(1), function(Data\Object $x) {})->end()->unbox();
		...
		public function testCompareTo($provided, $expected) {
			$p0 = Data\Object::box($provided[0])->compareTo(Data\Object::box($provided[1]));
			$e0 = $expected[0];
		...
		public function testToString($provided, $expected) {
			$p0 = Data\Object::box($provided[0])->__toString();
			$e0 = $expected[0];
