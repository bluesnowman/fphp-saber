...
namespace Saber\Data\Integer {
	...
	final class TypeTest extends Core\TypeTest {
		...
		public function testBox(array $provided, array $expected) {
			...
			$p0 = Integer\Type::box($provided[0]);
		...
		public function testMake(array $provided, array $expected) {
			...
			$p0 = Integer\Type::make($provided[0]);
		...
		public function testSingletons() {
			...
			$p0 = Integer\Type::negative();
			$e0 = Integer\Type::negative();
			...
			$p2 = Integer\Type::zero();
			$e2 = Integer\Type::zero();

			$this->assertInstanceOf('\\Saber\\Data\\Integer\\Type', $p2);
			...
			$this->assertInstanceOf('\\Saber\\Data\\Integer\\Type', $p4);
		...
		public function testHashCode(array $provided, array $expected) {
			$p0 = Integer\Type::make($provided[0])->__hashCode();
			$e0 = $expected[0];
		...
		public function testToString(array $provided, array $expected) {
			$p0 = Integer\Type::make($provided[0])->__toString();
			$e0 = $expected[0];
