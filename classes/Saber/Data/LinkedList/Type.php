...
namespace Saber\Data\LinkedList {
	...
	abstract class Type extends Data\Type implements Vector\Type {
		 ...
		 * @var string
		 */
		protected static $module = '\\Saber\\Data\\LinkedList\\Module';
		 ...
		 * @access public
		 * @static
		 * @param LinkedList\Type $x                                the class to be evaluated
		 * @return LinkedList\Type                                  the class
		 * @throw Throwable\InvalidArgument\Exception               indicated that the specified class
		 *                                                          is not a covariant
		 */
		public static function covariant(LinkedList\Type $x) {
