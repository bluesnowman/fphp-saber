...
namespace Saber\Data\Double {
	...
	final class TypeTest extends Core\TypeTest {
		...
		public function testSingletons() {
			...
			$p0 = Double\Type::negative();
			$e0 = Double\Type::negative();
			...
			$this->assertInstanceOf('\\Saber\\Data\\Double\\Type', $p2);
			...
			$this->assertInstanceOf('\\Saber\\Data\\Double\\Type', $p4);
		...
		public function testHashCode(array $provided, array $expected) {
			$p0 = Double\Type::make($provided[0])->__hashCode();
			$e0 = $expected[0];
