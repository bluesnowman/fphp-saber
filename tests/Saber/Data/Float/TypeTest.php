...
namespace Saber\Data\Float {
	...
	final class TypeTest extends Core\TypeTest {
		...
		public function testSingletons() {
			...
			$p0 = Float\Type::negative();
			$e0 = Float\Type::negative();
			...
			$this->assertInstanceOf('\\Saber\\Data\\Float\\Type', $p2);
			...
			$this->assertInstanceOf('\\Saber\\Data\\Float\\Type', $p4);
		...
		public function testHashCode(array $provided, array $expected) {
			$p0 = Float\Type::make($provided[0])->__hashCode();
			$e0 = $expected[0];
